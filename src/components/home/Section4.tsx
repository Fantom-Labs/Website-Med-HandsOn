...
export function Section4() {
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-6 h-full flex flex-col items-center">
        {/* Header */}
        <div className="flex items-center justify-between pt-12 mb-12 w-full" style={{ maxWidth: '1280px' }}>
          <h2 
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/cursos"
              className="flex items-center justify-center gap-4 transition-all hover:bg-white/10"
              style={{
                padding: '16px 32px',
        ...
        >
             <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
               {/* Image Side */}
               <div className="relative h-[400px] md:h-auto p-8">
