...
export function AboutHero() {
  return (
    <section className="relative bg-[#09111F] text-white py-20 md:py-32 overflow-hidden min-h-[700px] flex items-center">
      {/* Background Image */}
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="flex flex-col lg:flex-row items-center lg:items-start h-full">
           ...
           <div className="w-full lg:w-5/12 relative h-full min-h-[200px] lg:min-h-[auto]"></div>

           {/* Right side content */}
           <div className="w-full lg:w-7/12 lg:pl-20 mt-8 lg:mt-0">
            <h1 className="text-4xl md:text-5xl lg:text-[52px] font-semibold text-white leading-[1.15] mb-6 font-sans">
              Transformando o<br className="hidden lg:block" />
              ensino médico através<br className="hidden lg:block" />
              da prática real
            </h1>
            
            <p className="text-lg text-gray-300 mb-8 leading-relaxed max-w-xl font-sans">
            ...
            <Link
              href="/cursos"
              className="inline-flex items-center gap-2 bg-[#077DEA] hover:bg-[#0062B9] text-white px-8 py-4 rounded-lg font-medium transition-colors shadow-lg hover:shadow-blue-900/20"
            >
